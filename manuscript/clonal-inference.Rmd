...
The narrower range in clonal scenarios as compared to the microsatellite markers may be indicative of the increased precision that is observed when using SNP data [@rafiei2017comparsion].
