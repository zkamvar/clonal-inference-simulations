...
](figure/diversity_stats.pdf){#fig:simdiv width=100%}
...
= 0.01.
](figure/genomic_power.pdf){#fig:sim6 width=50%}
...
County, OR [@kamvar2015spatial]. The value of $\bar{r}_d$ for all 244 isolates
...
](figure/ROC_Curve.pdf){#fig:simroc width=100%}
...
](figure/AURC_genomic.pdf){#fig:sim7 width=50%}
