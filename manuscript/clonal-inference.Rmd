...
required to produce a value of $\bar{r}_d$ that is not significantly different from zero. This work indicated that
...
<!-- TODO -->
Sentence or two about the utility of these markers compared to SSRs for highly
clonal organisms, citing [@rafiei2017comparison].
<!-- TODO -->
The index of association was developed for multiple
...
![
Diagrammatic representation of the 1,000 simulated populations with different rates of sexual reproduction.
A) To create a population where a fraction (*s*) individuals are produced via sexual recombination, parents are sampled with replacement and mated until $s^{-1}$ individuals are produced.
After that, individuals from the parental population are randomly sampled with replacement to produce $(1 - s)^{-1}$ offspring.
This resulting population is then mutated and becomes the parental population. 
...
We controlled for the false discovery rate (FDR) using the Benjamini-Hochberg method [@benjamini1995controlling].
...
increases (Fig. \@ref(fig:sim4a), \@ref(fig:sim6)), suggesting that the behavior of
