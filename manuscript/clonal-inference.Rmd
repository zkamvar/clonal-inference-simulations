...
<!-- TODO: Perform the analyses and make this better -->
In light of this, we recommend to create an expected distribution of $\bar{r}_d$
by sub-sampling the data to the number of unique MLGs. If the clone-corrected
value of $\bar{r}_d$ falls within the distribution, then a rejection of the null
hypothesis of random mating may be feasible.
<!-- TODO -->
