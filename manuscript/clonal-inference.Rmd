...
hovering around 0.29. This is a pathogen that's known to be clonal, but if all
we did was assess the index of association on the clone-corrected estimate, we 
...
Our results confirm the concerns raised in
@tibayrenc1996towards of the increase of false negatives due to 
...
carefully, especially with haploid organisms in light of the fact that clone-
correction reduces sample size and power is significantly reduced with small
sample sizes.
