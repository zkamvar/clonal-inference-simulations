...
system.time({
res           <- load("../../simulation_results/ma_processed_results.rda")
...
# ggsave(file = "~/Documents/Grunwald/dissertation/figure/simulations/rd_sexrate.pdf",
...
diversity_plot <- vals %>%
  ...
  sample_colors
# ggsave(file = "~/Documents/Grunwald/dissertation/figure/simulations/diversity_stats.pdf",
#        plot = diversity_plot,
#        dpi = 600, width = 6, height = 7)
diversity_plot
```
