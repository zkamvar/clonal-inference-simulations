...
mat[c(1, 2, 5, 6)] <- c(z$grobs[[locations[1]]]$grobs, list(zeroGrob(), zeroGrob()))
mat[, 2] <- list(zeroGrob(), zeroGrob())
mat[2, 1] <- list(zeroGrob())
...
```{r, fig.width=10, fig.height = 7, fig.keep="last"}
AURC_by_seed %>% 
