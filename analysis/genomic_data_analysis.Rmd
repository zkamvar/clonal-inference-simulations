...
genomic_data <- load("../data/genomic_data.rda")
genomic_data
```
...
```{r, load_examples}
load("../data/genomic_rda_files/X.data.3639601.100.bpp.dir_genomic10_gen_10seed_0_sex_1.0000_gen_10000_rep_09.pop.feather.DATA.rda") %>% 
  get() %>% 
  tidyr::gather(key = percent_missing, value = dataset, starts_with("dataset")) -> x

xdat <- x$dataset[[2]]
xdat
load("../data/genomic_rda_files/X.data.3639601.1.grungall1.dir_genomic10_gen_10seed_0_sex_0.0000_gen_10000_rep_01.pop.feather.DATA.rda") %>%
  get() %>%
