...
script. These were saved in the `jack_rda_files/` directory.
...
```{r, cc_example, cache = TRUE, fig.width = 7, fig.height = 4}
library("poppr")
library("ggjoy")
data(Pram)
...
Ultimately, there is still no good way of assessing clonality. We must accept
the fact that $\bar{r}_d$ was simply not designed to be this sensitive to 
different levels of sexual reproduction. It may be more important to think about
what the biological consequence of 1% sexual reproduction in a population is. 
