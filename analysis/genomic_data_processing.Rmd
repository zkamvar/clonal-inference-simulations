...
datfiles <- dir(here::here("data", "genomic_rda_files/"), full.names = TRUE) %>% 
...
# Here we have to filter out the stored genetic data
datfiles <- dir(here::here("data", "genomic_rda_files_redux/"), full.names = TRUE)
...
save(original_redux, original, missing_stats, 
     file = here::here("data/genomic_data.rda"))
```
