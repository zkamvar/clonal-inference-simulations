...
datfiles  <- dir("../../simulation_results/ia_over_generations/", full.names = TRUE)
locfiles  <- dir("../../simulation_results/locus_diversity_over_generations/", full.names = TRUE)
...
iaplot <- datalist %>%
  ...
  facet_grid(mutation_rate + sample ~ sexrate) +
