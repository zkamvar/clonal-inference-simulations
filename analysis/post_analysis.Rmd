...
ggsave(file = "~/Documents/Grunwald/dissertation/figure/simulations/rd_sexrate.png",
...
ggplot(vals, aes(x = sexrate, y = B, fill = sample)) +
  geom_boxplot() +
  facet_wrap(~mutation_rate)
ggplot(vals, aes(x = sexrate, y = Evennesscc, fill = sample)) +
  geom_boxplot() +
  facet_wrap(~mutation_rate)
ggplot(vals, aes(x = sexrate, y = Hexp, fill = sample)) +
  geom_boxplot() +
  facet_wrap(~mutation_rate)
```
