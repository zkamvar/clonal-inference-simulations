...
datfiles  <- dir(here::here("data", "rda_files/"), full.names = TRUE) %>% 
  grep("feather[.a-z]*.rda$", ., value = TRUE)
divfiles  <- dir(here::here("data", "diversity_rda_files/"), full.names = TRUE)
locfiles  <- dir(here::here("data", "locus_rda_files/"), full.names = TRUE)
contfiles <- dir(here::here("data", "locus_contribution_rda_files/"), full.names = TRUE)
...
save(vals, file = here::here("data/processed_results.rda"))
save(datalist, file = here::here("data/full_results.rda"))
```
