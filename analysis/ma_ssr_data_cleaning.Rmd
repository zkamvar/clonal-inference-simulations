---
title: "SSR Data Cleaning (10-20 alleles per locus)"
...
This is identical to the report `ssr_data_cleaning.Rmd` except it processes the
simulations run with 10-20 alleles per locus for initial simulation parameters.
...
datfiles  <- dir("../../simulation_results/ma_rda_files/", full.names = TRUE) %>% 
  grep("feather[.a-z]*.rda$", ., value = TRUE)
divfiles  <- dir("../../simulation_results/ma_diversity_rda_files/", full.names = TRUE)
locfiles  <- dir("../../simulation_results/ma_locus_rda_files/", full.names = TRUE)
contfiles <- dir("../../simulation_results/ma_locus_contribution_rda_files/", full.names = TRUE)
...
save(vals, file = "../../simulation_results/ma_processed_results.rda")
save(datalist, file = "../../simulation_results/ma_full_results.rda")
```
