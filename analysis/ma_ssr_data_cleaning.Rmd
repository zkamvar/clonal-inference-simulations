...
datfiles  <- dir("../data/ma_rda_files/", full.names = TRUE) %>% 
  grep("feather[.a-z]*.rda$", ., value = TRUE)
divfiles  <- dir("../data/ma_diversity_rda_files/", full.names = TRUE)
locfiles  <- dir("../data/ma_locus_rda_files/", full.names = TRUE)
contfiles <- dir("../data/ma_locus_contribution_rda_files/", full.names = TRUE)
...
save(vals, file = "../data/ma_processed_results.rda")
save(datalist, file = "../data/ma_full_results.rda")
```
