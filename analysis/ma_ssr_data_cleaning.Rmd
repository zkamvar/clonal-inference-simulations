...
datfiles  <- dir(here::here("data", "ma_rda_files/"), full.names = TRUE) %>% 
  grep("feather[.a-z]*.rda$", ., value = TRUE)
divfiles  <- dir(here::here("data", "ma_diversity_rda_files/"), full.names = TRUE)
locfiles  <- dir(here::here("data", "ma_locus_rda_files/"), full.names = TRUE)
contfiles <- dir(here::here("data", "ma_locus_contribution_rda_files/"), full.names = TRUE)
...
save(vals, file = here::here("data/ma_processed_results.rda"))
save(datalist, file = here::here("data/ma_full_results.rda"))
```
